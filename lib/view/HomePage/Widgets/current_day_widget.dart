          ...
          RemoveGlowEffect(
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  SizedBox(width: 20),
                  WeatherHourListTile(weatherIcon: 'sun'),
                  SizedBox(width: 20),
                  WeatherHourListTile(weatherIcon: 'moon'),
                  SizedBox(width: 20),
                  WeatherHourListTile(weatherIcon: 'rain'),
                  SizedBox(width: 20),
                  WeatherHourListTile(weatherIcon: 'rain_and_sun'),
                  SizedBox(width: 20),
                  WeatherHourListTile(weatherIcon: 'cloudy'),
                  SizedBox(width: 20),
                  WeatherHourListTile(weatherIcon: 'cloud_and_sun'),
                ],
              ),
            ),
          )
